...
options:
    commit:
        description:
            - B(Deprecated)
            - Please use C(paloaltonetworks.panos.panos_commit_firewall), C(paloaltonetworks.panos.panos_commit_panorama),
              or C(paloaltonetworks.panos.panos_commit_push) instead.
            - HORIZONTALLINE
